...
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
            ...
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">{{ str_replace('_', ' ', $title) }}</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{ url('dashboard') }}">Home</a></li>
                        <li class="breadcrumb-item active">{{ str_replace('_', ' ', $title) }}</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card card-dark">
                        ...
                        <form method="POST">
                            @csrf
                            <input type="hidden" name="jenis" value="perubahan_modal">
                ...
                <div class="col-12 col-md-12">
                    <div class="card card-dark">
                        <div class="card-body" id="table_view">
                            ...
                            <h5 class="text-center">{{ str_replace('_', ' ', $title) }}</h5>

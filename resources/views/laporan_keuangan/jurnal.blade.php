                    ...
                    <div class="card card-dark">
                        ...
                        <form method="POST">
                            ...
                            <div class="card-footer d-flex flex-row align-items-center">
                                ...
                                <a href="{{ url('export/jurnal') }}" class="btn btn-success ml-1" id="export"><i
        ...
        $(document).ready(function() {
            ...
            var validator = $("form").validate({
                ...
                submitHandler: function(form) {
                    ...
                    var b1 = $(form).find('#bulan_awal option:selected').text();
                    var b2 = $(form).find('#bulan_akhir option:selected').text();
                    var th = $(form).find('#tahun option:selected').text();

                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header d-flex flex-row align-items-center">
                            <h3 class="card-title"><i class="fa fa-2 fa-book" aria-hidden="true"></i></h3>
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-sm-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="no_reff" id="no_reff" readonly class="form-control">
                                </div>
                            </div>
        ...
        $(document).ready(function() {
            ...
            var table = $('#table1').DataTable({
                ...
                "footerCallback": function(row, data, start, end, display) {
                    ...
                    $(api.column(3).footer()).html(numFormat(debet));
                    $(api.column(4).footer()).html(numFormat(kredit));
                    $(api.column(5).footer()).html(balanced);

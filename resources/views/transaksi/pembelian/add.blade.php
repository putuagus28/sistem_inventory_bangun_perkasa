                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header d-flex flex-row align-items-center">
                            <button type="button" onclick="window.location.href='{{ route('transaksi.pembelian') }}'"
                                ...
                                <div class="col-12 my-auto">
                                    <form action="" method="post" id="formCartBarang">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-12 col-md-2">
                                                <div class="form-group">
                                                    <label for="">Masukan Qty Beli</label>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#batalkan').on('click', function() {
                if (confirm('Klik Ok untuk membatalkan semua pembelian')) {
                    $.get("{{ route('removeall.pembelian') }}",
                        function(data, textStatus, jqXHR) {
                            if (data.status) {
                                listCart();
                            }

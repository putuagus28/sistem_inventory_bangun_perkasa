                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header d-flex flex-row align-items-center">
                            ...
                            <button type="button" onclick="window.location.href='{{ route('pembelian.add') }}'"
        ...
        $(document).ready(function() {
            ...
            table.on("click", "#delete", function(e) {
                ...
                Swal.fire({
                    ...
                    text: 'Jika anda menghapus maka, stok sebelumnya akan kembali seperti sebelum anda melakukan pembelian',
                    icon: 'info',
